...
//        adj = new Bag<Integer>[V];
   ...
   /**  
     * Create a digraph from input stream.  <<<<< CHECK THIS ERROR is graph not digraph
     */
    public Graph(In in) {
        this(in.readInt());
        int E = in.readInt();
   ...
   /**
    ...
    public static void main(String[] args) {
    	String filenamepath ="./src/tinyG.txt";
        In in = new In(filenamepath) ; // (args[0]);
